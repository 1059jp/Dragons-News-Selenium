...
# GitHubの「金庫（Secrets）」から読み込む（コードには直接書きません）
...
def create_html(news_list):
    ...
    <head>
        ...
        <style>
            ...
            .summary-box {{ background: #e1f5fe; padding: 10px; border-radius: 8px; font-size: 0.9em; margin: 10px 0; border-left: 4px solid #1d9bf0; color: #1a1a1a; }}
