...
# GitHubの「金庫（Secrets）」からAPIキーを安全に読み込む
...
def create_html(news_list):
    ...
    <head>
        ...
        <style>
            ...
            .post-btn {{ display: inline-block; background: #1d9bf0; color: white; text-decoration: none; padding: 10px 20px; border-radius: 30px; font-weight: bold; }}
        </style>
    </head>
    <body>
